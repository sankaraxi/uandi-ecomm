export default function CurateYourRoutinePage() {
  return (
        ...
        <section className="relative p-8 sm:p-12 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-gray-700">
              Curate Your Routine is here to build a skincare kit — multiple products at a single price for all the
              products selected in the kit.
            </p>
            ...
            <div className="mt-8 flex flex-col items-center gap-3">
              <img
                ...
                loading="lazy"
              />
              <span className="text-xs flex items-center  sm:text-sm" style={{ color: "#8c2b3d" }}>
